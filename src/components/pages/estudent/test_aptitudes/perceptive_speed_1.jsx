        ...
        <Form>
          <div className="h-screen flex justify-center relative overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-6xl px-6 py-10 overflow-y-auto scrollbar-hide">
              ...
              <motion.div
                className="mb-8 bg-gradient-to-r from-white to-white dark:from-black/50 dark:to-gray-900/50 rounded-3xl p-6 shadow-2xl backdrop-blur-md border border-teal-400/30 text-gray-200 leading-relaxed"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ duration: 0.8, delay: 0.2 }}
              >
                <h3 className="dark:text-teal-400 font-bold text-xl mb-4 text-black">
                  INSTRUCCIONES:
                </h3>
                <ul className="list-disc list-inside space-y-2 text-black dark:text-teal-400">
                  <li>
                    Cada ejercicio muestra cinco grupos de letras y/o números.
                  </li>
                  <li>
                    Solo uno de los grupos está{" "}
                    <span className="dark:text-teal-300 font-semibold text-black">
                      subrayado
                    </span>
                    .
                  </li>
                ...
                {preguntas.map((pregunta) => (
                  ...
                  >
                    <div className="mb-3">
                      ...
                      <div className="dark:bg-gray-800/50 p-3 rounded-lg border border-gray-600 text-center font-bold dark:text-white text-black text-xl">
                        {pregunta.opciones.map((opcion, index) => (
                          <span
                            key={index}
                            className={`mx-1 ${
                              opcion === pregunta.respuesta
                                ? "underline dark:decoration-teal-400 decoration-[5px] font-extrabold"
                                : ""
                            }`}
                          >
                            {opcion}
